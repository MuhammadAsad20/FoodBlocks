                    ...
                    <div className="flex justify-center flex-wrap -m-4">
                        ...
                        <div className="p-4 lg:w-1/4 md:w-1/2">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full  flex flex-col items-center ">
                                    <h2 className="title-font font-bold text-xl text-gray-900"  style={{ fontFamily: 'Great Vibes, cursive' }}>Holden Caulfield</h2>
                        ...
                        <div className="p-4 lg:w-1/4 md:w-1/2">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full  flex flex-col items-center ">
                                    <h2 className="title-font font-bold text-xl text-gray-900" style={{ fontFamily: 'Great Vibes, cursive' }}>Atticus Finch</h2>
                                    <p className="w-3/4 mb-4 text-md">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4 lg:w-1/4 md:w-1/2">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full flex flex-col items-center ">
                                    <h2 className="title-font font-bold text-xl text-gray-900" style={{ fontFamily: 'Great Vibes, cursive' }}>Jeanette Mccarthy</h2>
                                    <p className="w-3/4 mb-4 text-md">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                </div>
                            </div>
                        </div>
